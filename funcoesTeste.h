...
struct tipoCurso{ 
    ...
    int quantAC=0, quantL1=0, quantL3=0, quantL4=0, quantL5=0, quantL7=0, quantL8=0, quantL9=0, quantL11=0, quantL13=0, quantL15=0; 
...
void eP_NotaFinal(acertos_notas aluno[], tipoCurso curso[], int quant, int qtdCursos, float media[], float desvio[]);
